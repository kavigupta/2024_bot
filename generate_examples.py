...
model.sample("2020 Actual", seed=None, path="images/2020_actual.svg", adjust=False, data=all_data())
model.sample("2020 Pred", seed=None, path="images/2020_pred.svg", adjust=False, correct=False, data=all_data())
